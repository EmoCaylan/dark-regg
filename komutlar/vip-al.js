...
let vipal = message.guild.roles.cache.find(r => r.id === ayarlar.vip)
if(!["832366079157207102"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
