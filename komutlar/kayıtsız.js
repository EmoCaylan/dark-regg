...
message.channel.send(new MessageEmbed().setDescription(`${kullanici} Adlı kullanıcıya ${kayıtsız} Rolü Verildi`).setColor('0x348f36').setFooter(message.author.tag, message.author.avatarURL({dynamic: true})).setTimestamp()) 
